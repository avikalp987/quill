...
export const ChatContextProvider = ({fileId, children}: Props) => {
    ...
    //mutate function for sending the message
    const { mutate: sendMessage } = useMutation({
                    ...
                    let updatedPages = old.pages.map((page) => {
                        if(page === old.pages[0])
                        {
                            ...
                            if(!isAIResponseCreated)
                            {
                                ...
                                //if already an ai response is present
        ...
        onSettled: async () => {
            ...
            await utils.getFileMessages.invalidate({fileId}) //refresh the entire data and utils act as a proxy serevr
        }
    })
