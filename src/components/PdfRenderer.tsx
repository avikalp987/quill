...
const PdfRenderer = ({url}: PdfRendererProps) => {
    ...
    //keeping the track on which page we are
    const [currPage, setCurrPage] = useState<number>(1)

    //setting the zoomed state
    const [scale, setScale] = useState<number>(1)

    //setting the current rotation state
    const [rotation, setRotation] = useState<number>(0)

    //rendered scale state
    ...
    //getting the type of our custom validator
    type TCustomPageValidator = z.infer<typeof CustomPageValidator>

    //getting the react hook form set up
    const {
        register,
        handleSubmit,
        formState: {
    ...
    //creating our handle submit function
